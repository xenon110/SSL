...
export default function ExecutivePage() {
      ...
      <div className="flex flex-col items-center justify-center h-[70vh] text-center p-6">
        <div className="bg-red-50 p-6 rounded-2xl max-w-md border border-red-100 shadow-sm">
          ...
          <p className="text-slate-600 mb-6 text-sm">
            {error || "Your Tally sync agent hasn't pushed the Executive Summary data to the database yet. Please ensure the sync script is running."}
          </p>
  ...
  return (
    <div className="p-6 space-y-6">
      <GenericDashboardView title="Executive Summary" data={data} />
    </div>
  );
}
