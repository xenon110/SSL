...
if __name__ == "__main__":
    ...
    names = [
        "Profit and Loss", "Profit & Loss", "Profit and Loss Account", "Profit & Loss Account",
        "P & L A/c", "P&L", "Statement of Profit and Loss", "Statement of Profit & Loss",
        "Profit and Loss A/c", "Profit & Loss A/c"
    ]
