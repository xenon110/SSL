            ...
            <EXPORTDATA>
                <REQUESTDESC>
                    ...
                    <STATICVARIABLES>
                        ...
                        <SVSHOWINWARDS>Yes</SVSHOWINWARDS>
                        <SVSHOWOUTWARDS>Yes</SVSHOWOUTWARDS>
                        <SVSHOWOPENING>Yes</SVSHOWOPENING>
                    </STATICVARIABLES>
                </REQUESTDESC>
            </EXPORTDATA>
        </BODY>
...
if __name__ == "__main__":
    ...
    for name in names:
        ...
        if "LINEERROR" not in res and "Unknown Request" not in res:
            ...
            with open("stock_summary_response_detailed.xml", "w", encoding="utf-8") as f:
                f.write(res)
            break
        else:
            print(f"Failed: {name}")
